...
import { useAddPlansMutation } from "../../slices/adminAdminApiSlice";
...
// const AddPlanForm = ({ setRefresher }) => {
//   const [plan, setPlan] = useState("");
//   const [price, setPrice] = useState("");
//   const [duration, setDuration] = useState("");
//   const [description, setDescription] = useState("");
...
//             <label className="block text-sm font-bold mb-4">Plan</label>
//             <input
//               className={`shadow appearance-none border rounded w-22 py-2 px-4 text-white bg-gray-700 ${
//                 planError ? "border-red-500" : ""
//               }`}
//               type="text"
//               placeholder="Plan"
...
//           </div>
//           <div className="w-1/2">
//             <label className="block text-sm font-bold mb-4">Price</label>
//             <input
//               className={`shadow appearance-none border rounded w-22 py-2 px-4 text-white bg-gray-700 ${
//                 priceError ? "border-red-500" : ""
//               }`}
...
//         </div>
//         <div className="mb-4">
//           <label className="block text-sm font-bold mb-4">Duration</label>
//           <input
//             className={`shadow appearance-none border rounded w-22 py-2 px-4 text-white bg-gray-700 ${
//               durationError ? "border-red-500" : ""
//             }`}
...
//         </div>
//         <div className="mb-4">
//           <label className="block text-sm font-bold mb-4">Description</label>
//           <input
//             className={`shadow appearance-none border rounded w-22 py-2 px-4 text-white bg-gray-700 ${
//               descriptionError ? "border-red-500" : ""
//             }`}
...
//           <button
//             className="text-white bg-blue-500 active:bg-blue-500 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg focus:outline-none mt-4"
//             type="submit"
//           >
//             Add Plan
//           </button>
