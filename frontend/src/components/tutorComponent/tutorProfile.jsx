...
// import { useUpdateTutorMutation } from "../../slices/tutorApiSlice";
...
//   const tutorQualifications = tutorInfo?.qualifications || '';
//   const tutorExperience = tutorInfo?.experience || '';
...
//     setName(tutorName);
//     setEmail(tutorEmail);
//     setQualifications(tutorQualifications);
//     setExperience(tutorExperience);
//   }, [tutorName, tutorEmail, tutorQualifications, tutorExperience]);
...
const TutorProfile = () => {
  ...
  useEffect(() => {
    setName(tutorInfo.name);
    setEmail(tutorInfo.email);
    setQualifications(tutorInfo.qualification);
    setExperience(tutorInfo.experience);
    setAbout(tutorInfo.about);
  }, [
    tutorInfo.name,
