...
const createRoom = asyncHandler(async (req, res) => {
    console.log("Entered into create ROom  ///////");
  try {
...
const getRooms = asyncHandler(async (req, res) => {
  ...
  // });
  const rooms = await ChatRoom.find({ user: { $ne: userId} })
...
//    const rooms = await ChatRoom.findOne({user: userId})
//    console.log(rooms,"rooms");
//    res.send(rooms)
//  })
...
const chatSend = asyncHandler(async (req, res) => {
    console.log("Enteed inot chat senddddddddd");
  ...
  console.log(newMessage,"newMWsssssssss");
...
const getMessages = asyncHandler(async (req, res) => {
    console.log("Entered intp  getMessaged .........");
